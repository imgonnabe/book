          ...
          <div class="container" style="width: 100%; margin-bottom: 50px;">
            ...
            <div class="container">
              ...
              <div class="first">
               <div class="firstb">
               <c:choose>
               <c:when test="${sessionScope.mid ne null}"><button type="button" class ="btn btn-border-d btn-round firstb" onclick="location.href='./bwrite?board=${param.board}'">글쓰기</button> &nbsp; &nbsp;</c:when>
               ...
               <tr class="row detail" onclick="location.href='./bdetail?board=${param.board}&bno=${row.bno}'">
               		<td class="col-7 title">${row.btitle }<c:if test="${row.commentcount  ne 0}">&nbsp;<span class="badge bg-danger">${row.commentcount  }</span></c:if></td>
               		<td class="col-2">${row.bdate }</td>
               		<td class="col-2">${row.mid }</td>
