  ...
  <%@ include file="../menu.jsp"%>
    <main>
      <div class="main">
       ...
       <hr class="divider-w">
          <div class="container con" style="width:100%" >
             ...
             <div class="col-sm-8 col-sm-offset-1">
                  ...
                  <div class="post-header font-alt">
                    ...
                    <div class="post-meta">By&nbsp;<a href="#">${ndetail.mid }</a>| ${ndetail.ndate }| ${ndetail.nno } | <a href="#">${ndetail.ncate} </a>|&nbsp;<a href="#"></a>
		<c:if test="${sessionScope.mid eq ndetail.mid ||  sessionScope.mgarde eq 2}"><button onclick="edit()">수정하기</button><button onclick="del()">삭제하기</button></c:if></div>
                    </div>
