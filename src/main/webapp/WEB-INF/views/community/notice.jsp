       ...
       <hr class="divider-w">
          <div class="container" style="width: 100%">
            ...
            <div class="container">
               ...
               <div class="firstb">
               	<c:choose>
               <c:when test="${sessionScope.mgrade eq 2}"><button type="button" class ="btn btn-border-d btn-round firstb" onclick="location.href='./nwrite?board=${param.board}'">글쓰기</button></c:when>
